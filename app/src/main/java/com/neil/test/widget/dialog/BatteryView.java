//package com.neil.test.widget.dialog;
//
...
//        //画电池内矩形电量
//        float offset = (width - strokeWidth * 4) * mPower / 100.f;
//        RectF r2 = new RectF(2*strokeWidth, 2*strokeWidth, offset, height - 2*strokeWidth);
//        //根据电池电量决定电池内矩形电量颜色
//        if (mPower < 30) {
...
//        //画电池头
//        RectF r3 = new RectF(width - 2 * strokeWidth, height * 0.25f, width, height * 0.75f);
//        //设置电池头颜色为白色
//        paint.setColor(mColor);
